...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Layla88',
      password: 'BIZHk38bYiFSjzq',
      email: 'Eloisa_Kuhlman@gmail.com',
      name: 'Mr. Philip Lueilwitz',
      mobileNo: '(905) 284-3194',
      userType: 506,
      resetPasswordLink: {},
      loginRetryLimit: 585,
      loginReactiveTime: '2023-02-23T09:26:40.293Z',
      id: '622852f14f2e765999eefd06'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Roosevelt_Nolan43',
        'password':'G9vIrfOVXj4pXkM',
        'email':'Avery57@hotmail.com',
        'name':'Franklin Feeney',
        'mobileNo':'(827) 431-6694',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Avery57@hotmail.com', });
