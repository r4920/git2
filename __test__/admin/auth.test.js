...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Herman.Mills77',
      password: '1VXBMkDmQ9jUmkW',
      email: 'Kattie.Hoppe59@gmail.com',
      name: 'Brittany Towne',
      mobileNo: '1-660-495-0984',
      userType: 735,
      resetPasswordLink: {},
      loginRetryLimit: 286,
      loginReactiveTime: '2023-01-09T19:46:04.088Z',
      id: '622852f14f2e765999eefce2'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Casandra_Heaney',
        'password':'NpYF1dtaiI1ZdL6',
        'email':'Wilbert39@gmail.com',
        'name':'Mrs. Mario Schaefer',
        'mobileNo':'630.814.7619 x05621',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Wilbert39@gmail.com', });
